...
<head>
    ...
    <title>Coverage for venv/lib/python3.8/site-packages/rest_auth/admin.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>venv/lib/python3.8/site-packages/rest_auth/admin.py</b> :
...
<div id="source">
    <p id="t1" class="pln"><span class="n"><a href="#t1">1</a></span><span class="t"><span class="com"># from django.contrib import admin</span>&nbsp;</span><span class="r"></span></p>
